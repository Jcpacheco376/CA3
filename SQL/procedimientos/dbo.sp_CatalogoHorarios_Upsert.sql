...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            ROLLBACK;
            RAISERROR ('La abreviatura del horario ya está en uso por otro horario activo.', 16, 1);
            RETURN;
        END
        ...
        -- 3. Actualización de Detalles Locales
        ...
        -- =========================================================================
        -- 5. SINCRONIZACIÓN (NUEVA INTEGRACIÓN)
        -- =========================================================================
        IF (SELECT ConfigValue FROM dbo.ConfiguracionSistema WHERE ConfigKey = 'SyncHorarios') = 'true'
        BEGIN
            PRINT 'Paso Sync: Sincronización (PUSH) de Horario habilitada.';
            EXEC [dbo].[sp_SyncToExternal_Horario] @HorarioId = @HorarioId;
        END
        ELSE
        BEGIN
             PRINT 'Paso Sync: Sincronización (PUSH) deshabilitada.';
        END
