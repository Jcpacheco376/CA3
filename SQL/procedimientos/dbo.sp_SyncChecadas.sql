-- ──────────────────────────────────────────────────────────────────────
-- Stored Procedure: [dbo].[sp_SyncChecadas]
-- Base de Datos:       CA
-- Versión de Paquete:  v1.3.68
-- Compilado:           10/03/2026, 09:01:16
    ...
    BEGIN
        ...
        BEGIN
            ...
            SET @remoteSql = 
                ...
                N'WHERE fecha >= ''' + @FI_ISO + N''' AND fecha < ''' + @FF_ISO + N''' ' +
                @EmpFilter + N';';
        END
        ...
        BEGIN
            ...
            SET @remoteSql = 
                ...
                N'WHERE a.punch_time >= ''' + @FI_ISO + N''' AND a.punch_time < ''' + @FF_ISO + N''' ' +
                @EmpFilter + N';';
        END
