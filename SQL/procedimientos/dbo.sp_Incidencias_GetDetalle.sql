...
BEGIN
    ...
    -- RESULTSET 1: HEADER (Sin cambios, tu lógica es correcta)
    SELECT 
    ...
    SELECT 
        ...
        -- IDs de Auditoría Técnica (Agregados para completar la refactorización)
    ...
    ORDER BY b.FechaMovimiento ASC; -- Orden cronológico para leer la historia
